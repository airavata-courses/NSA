...
public final class userGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<proto_files.User.LoginRequest,
      proto_files.User.LoginRequestAPIResponse> getLoginMethod;
  ...
  public static io.grpc.MethodDescriptor<proto_files.User.LoginRequest,
      proto_files.User.LoginRequestAPIResponse> getLoginMethod() {
    io.grpc.MethodDescriptor<proto_files.User.LoginRequest, proto_files.User.LoginRequestAPIResponse> getLoginMethod;
    if ((getLoginMethod = userGrpc.getLoginMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getLoginMethod = userGrpc.getLoginMethod) == null) {
          userGrpc.getLoginMethod = getLoginMethod = 
              io.grpc.MethodDescriptor.<proto_files.User.LoginRequest, proto_files.User.LoginRequestAPIResponse>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<proto_files.User.Empty,
      proto_files.User.LoginRequestAPIResponse> getLogoutMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = proto_files.User.LoginRequestAPIResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto_files.User.Empty,
      proto_files.User.LoginRequestAPIResponse> getLogoutMethod() {
    io.grpc.MethodDescriptor<proto_files.User.Empty, proto_files.User.LoginRequestAPIResponse> getLogoutMethod;
    if ((getLogoutMethod = userGrpc.getLogoutMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getLogoutMethod = userGrpc.getLogoutMethod) == null) {
          userGrpc.getLogoutMethod = getLogoutMethod = 
              io.grpc.MethodDescriptor.<proto_files.User.Empty, proto_files.User.LoginRequestAPIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "user", "logout"))
              .setSampledToLocalTracing(true)
  ...
  public static abstract class userImplBase implements io.grpc.BindableService {
    ...
    public void login(proto_files.User.LoginRequest request,
        io.grpc.stub.StreamObserver<proto_files.User.LoginRequestAPIResponse> responseObserver) {
  ...
  public static final class userFutureStub extends io.grpc.stub.AbstractStub<userFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto_files.User.LoginRequestAPIResponse> login(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto_files.User.LoginRequestAPIResponse> logout(
